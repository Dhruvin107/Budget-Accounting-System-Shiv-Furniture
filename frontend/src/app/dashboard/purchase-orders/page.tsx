...
import { purchaseOrdersApi, contactsApi, productsApi } from '@/lib/api'
...
import type { PurchaseOrder, Contact, Product } from '@/types'
...
export default function PurchaseOrdersPage() {
  ...
  const handleGeneratePdf = async (id: string) => {
    try {
      const response = await purchaseOrdersApi.generatePdf(id)
                ...
                <TableBody>
                  {orders.map((order) => (
                    <TableRow key={order._id}>
                      ...
                      <TableCell>{order.expected_date ? formatDate(order.expected_date) : '-'}</TableCell>
